...
const Hero = () => {
    return (
        <>
        <div className='w-full pt-20 md:pt-36 pb-20 bg-gradient-to-b from-yellow-400 to-yellow-200'>
            ...
            <div className='Order w-full mx-auto p-3 mt-12 md:w-6/12 md:mt-24'>
            ...
            <div className='info w-11/12 md:w-6/12 mt-12 md:mt-16 flex justify-between p-3 gap-x-4 md:gap-x-8 mx-auto'>
